...
func _process(_delta):
	...
	index_report_pill.add_theme_stylebox_override("normal", index_report_stylebox if have_index_report else inactive_stylebox)
	vuln_report_pill.add_theme_stylebox_override("normal",  vuln_report_stylebox if have_vuln_report else inactive_stylebox)
